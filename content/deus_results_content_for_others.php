            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="contact-area deus_version deus_bloc">
                        <h1 class="title_deus_test"> <?php echo $i18n->deus_results->title; ?> <i>#<?php echo $_GET['id']; ?></i></h1>
                        <div class="contact-form-area">
                            <div class="row justify-content-center mb-30-none" id="deus_result">
                                ...
                                <span class="text-left deus_notice deus_info"><?php echo $i18n->deus_results_others->notice; ?>
                                </span>
                                <!-- Display Graph -->
