                    ...
                    <div class="contact-area deus_version deus_bloc">
                        <div class="contact-form-area">
                            <div class="row justify-content-center mb-30-none" id="deus_result">
                                ...
                                <span class="text-left deus_notice deus_info" data-i18n="deus_form_notice_postform"> Cette "étude de la personnalité" se base sur le format du Big Five <br />et reprend le format 10 items, réduis à 8, suivant le modèle établi par Jason VandenBerghe. <br />
                                DeusSearch établi une pondération des données que l'utilisateur à rentré pour les comparer à sa base de données.
                                </span>
                            </div>
                        </div>
                    </div>
